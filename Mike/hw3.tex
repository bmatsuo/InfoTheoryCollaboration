...
e) \textbf{[fill in calc steps with cites to calc rules, maybe a few milestones (discuss in group)]}
By calculus: \( p=\frac{(3-5^{1/2})}{2}=0.382.\) the max value is \(H(p)=H(1-p)=H(\frac{5^{1/2}-1}{2}) = 0.694bits\)
